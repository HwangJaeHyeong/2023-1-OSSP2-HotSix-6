    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('group_code', models.ForeignKey(blank=True, db_column='Group_Code', null=True, on_delete=django.db.models.deletion.DO_NOTHING, to='accounts.group')),
            ],
            options={
        ...
        migrations.CreateModel(
            name='GroupTask',
            fields=[
                ('task_id', models.CharField(db_column='Project_ID', max_length=20, primary_key=True, serialize=False)),
                ('task_name', models.CharField(db_collation='utf8mb4_0900_ai_ci', db_column='Project_Name', max_length=15)),
                ('task_progress', models.IntegerField(db_column='Project_Progress')),
        ...
        migrations.CreateModel(
            name='GroupNotice',
            fields=[
                ('notice_id', models.CharField(db_column='Notice_ID', max_length=20, primary_key=True, serialize=False)),
