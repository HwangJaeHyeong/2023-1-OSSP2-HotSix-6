...
class Group(models.Model):
    ...
    creator_id = models.CharField(db_column='Creator_ID', max_length=15)  # Field name made lowercase.
...
class GroupMember(models.Model):
    ...
    member_id = models.CharField(db_column='Member_ID', max_length=15)  # Field name made lowercase.
...
class GroupNotice(models.Model):
    ...
    notice_title = models.CharField(db_column='Notice_Title', max_length=15)  # Field name made lowercase.
    notice_content = models.CharField(db_column='Notice_Content', max_length=100, blank=True, null=True)  # Field name made lowercase.
...
class GroupProject(models.Model):
    ...
    group_code = models.ForeignKey(Group, models.DO_NOTHING, db_column='Group_Code')  # Field name made lowercase.
    project_name = models.CharField(db_column='Project_Name', max_length=15)  # Field name made lowercase.
...
class GroupSchedule(models.Model):
    ...
    group_code = models.ForeignKey(Group, models.DO_NOTHING, db_column='Group_Code')  # Field name made lowercase.
    schedule_title = models.CharField(db_column='Schedule_Title', max_length=15)  # Field name made lowercase.
    schedule_content = models.CharField(db_column='Schedule_Content', max_length=100, blank=True, null=True)  # Field name made lowercase.
...
class Time(models.Model):
    time_id = models.CharField(db_column='Time_ID', primary_key=True, max_length=15)  # Field name made lowercase.
...
class User(models.Model):
    ...
    email = models.CharField(db_column='Email', max_length=15)  # Field name made lowercase.
