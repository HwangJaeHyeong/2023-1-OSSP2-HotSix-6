...
const MainScreen = ({ navigation }) => {
  return (
    <ImageBackground source={require('assets/images/background_img_1.png')} style={styles.container}>
      <View style={styles.contentContainer}>
        <Text style={styles.title}>메인화면</Text>
        <TouchableOpacity style={styles.loginButton} onPress={() => navigation.navigate('Group')}>
