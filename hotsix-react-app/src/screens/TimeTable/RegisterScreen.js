import mainLogoImg from 'assets/images/main_logo_img.png'
import { Image, ImageBackground, StyleSheet, Text, TouchableOpacity, View } from 'react-native'

const RegisterScreen = ({ navigation }) => {
  return (
    <ImageBackground source={require('assets/images/background_img_3.png')} style={styles.container}>
      <Image source={mainLogoImg} style={styles.logoImage} />
      <View style={styles.buttonContainer}>
        <TouchableOpacity style={styles.loginButton} onPress={() => navigation.navigate('InsertPhoto')}>
